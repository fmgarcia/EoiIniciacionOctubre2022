...
public class Inventario {
	...
	public static List<Electrod> rellenaLista() {
		List<Electrod> lista;
		lista=new ArrayList<>();
	...
	private static List<Electrod> rellenaBlanca(){
	...
	private static List<Electrod> rellenaMarron(){
	...
	private static List<Electrod> rellenaGris(){
	...
	private static List<Electrod> rellenaPae(){
	...
	public static void guardaElemento(Electrod elemento){
		PrintWriter writer=null;
		try {
			if (elemento instanceof Blanca) {
				 writer = new PrintWriter(new FileWriter("blanca.txt", true));
			} else if (elemento instanceof Gris) {
				 writer = new PrintWriter(new FileWriter("gris.txt", true));
			}
			 else if (elemento instanceof Pae) {
				 writer = new PrintWriter(new FileWriter("pae.txt", true));
			}
			else if (elemento instanceof Marron) {
				 writer = new PrintWriter(new FileWriter("marron.txt", true));
			}
			writer.println(elemento.cadenaFichero());
		}
		catch (IOException e){
			e.printStackTrace();
		}
